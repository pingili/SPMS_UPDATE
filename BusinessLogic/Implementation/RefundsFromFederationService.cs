...
{
    public class RefundsFromFederationService 
    {
        ...
        public List<RefundsFromFederationLookUpDto> RefundsFromFederationLookup(int GroupID)
        {
            List<RefundsFromFederationLookUpDto> lstRefundsFromFederationLookUpDto = new List<RefundsFromFederationLookUpDto>();
            ...
            {
                RefundsFromFederationLookUpDto refundsFromFederationLookUpDto = Mapper.Map<uspRefundsFromFederationLookup_Result, RefundsFromFederationLookUpDto>(RefundsFromfederation);
