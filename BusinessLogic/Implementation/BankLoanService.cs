...
namespace BusinessLogic
{
    public class BankLoanService
    {
        ...
        public bool CheckLoanExisted(int grouID, int slAHID,string loanNumber) {
            BankLoanDataAccess bldataaccess = new BankLoanDataAccess();
            return bldataaccess.CheckLoanExisted(grouID, slAHID, loanNumber);
        }
        ...
        public List<BankLoanLookupDto> Lookup(int GroupID, int userId)
        {
            BankLoanDataAccess objbankloandal = new BankLoanDataAccess();
            return objbankloandal.GetBankLoanLookup(GroupID, userId);
        }

        public BankLoanDto GetBankLoanApplicationDetailsById(int LoanMasterId)
        {
            BankLoanDataAccess objBankLoanDal = new BankLoanDataAccess();
            return objBankLoanDal.GetBankLoanApplicationDetailsById(LoanMasterId);
        }
