...
namespace MFIS.Web.Areas.Group.Controllers.TransactionControllers
{
    public class MemberLoanDisbursementController : BaseController
    {
        ...
        public MemberLoanDisbursementController()
        {
        ...
        [HttpGet]
        public ActionResult CreateMemberLoanDisbursementNew(string Id)
        {
        ...
        {
            var lstGroupLoanDisbursementLookupDto = _memberLoanDisbursementService.MemberLoanDisbursementLookup(GroupInfo.GroupID, UserInfo.UserID);
