...
namespace MFIS.Web.Areas.Group.Controllers.TransactionControllers
{
    public class RefundsFromFederationController : BaseController
    {
        ...
        private readonly RefundsFromFederationService _refundsFromFederationService;
        ...
        public RefundsFromFederationController()
        {
            ...
            _dbContext = new MFISDBContext();
            _refundsFromFederationService = new RefundsFromFederationService();
            _bankService = new BankService();
            _groupReceiptService = new GroupReceiptService();
            _employeeService = new EmployeeService();
        ...
        [HttpGet]
        public ActionResult CreateRefundsFromFederation(string Id)
        {
            ...
            {
                objDto = _refundsFromFederationService.GetByID(AccountMasterId);
                ...
                {
                    ViewBag.Message = "Account Master is not in Active";
                    return View(objDto);
                }
            }
        ...
        public ActionResult CreateRefundsFromFederation(FormCollection form)
        {
            ...
            if (generalpaymentsDto.AccountMasterID == 0)
                resultDto = _refundsFromFederationService.Insert(generalpaymentsDto);
            else
                resultDto = _refundsFromFederationService.Update(generalpaymentsDto);
            List<uspAccountHeadGetAll_Result> lstuspAccountHeadGetAll_Result = _dbContext.uspAccountHeadGetAll().ToList();
        ...
        public ActionResult RefundsFromFederationLookup()
        {
            ...
            var lstGeneralPaymentsDto = _refundsFromFederationService.RefundsFromFederationLookup(GroupId);
        ...
        public ActionResult DeleteRefundsFromFederation(string Id)
        {
            ...
            ResultDto resultDto = _refundsFromFederationService.Delete(AccountmasterId, UserInfo.UserID);
        ...
        public ActionResult ActiveInactiveRefundsFromFederation(string Id)
        {
            ...
            ResultDto resultDto = _refundsFromFederationService.ChangeStatus(AccountmasterId, UserInfo.UserID);
        ...
        {
            int GroupId = GroupInfo.GroupID;
            List<ReceiptTranscationDto> lstGroupReceiptTranscationDto = _refundsFromFederationService.GetAccountdetails(GroupId);
